...
roll_first_column = [[257, 55], [257, 82], [257, 112], [257, 142], [257, 172], [257, 202],[257, 232], [257, 262],[257, 292],[257, 324]]
...
def find_and_draw_squares(image_path, output_path, answer_key_file, cap_given, has_shadow, allow_parcial_marking, new_cods_=[]):
    roll_pixel = 225
    white_pixel_value = 220 # int(config.get('settings', 'pixel_value')) #230 # 170
    m_area = 150
